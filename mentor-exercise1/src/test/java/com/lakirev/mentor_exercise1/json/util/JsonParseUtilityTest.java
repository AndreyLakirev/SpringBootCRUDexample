...
public class JsonParseUtilityTest {
    ...
    public void getMajorJsonObjects() {
        List<String> majorObjects = parseUtility.getMajorJsonObjects(CustomerTestData.CUSTOMER_JSON_LIST.toCharArray());
    ...
    public void getObjectParameters() {
        try {
            ReflectionJsonParser parser = new ReflectionJsonParser(parseUtility);
